...
def predict_audio(wav_file_path, params, args, model, unit2char):
    # 读取和预处理音频文件
    feature, feature_length = process_audio(wav_file_path, params)
    
    # 将特征转化为Tensor
    features = torch.FloatTensor(feature).unsqueeze(0)  # 添加batch维度
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--load_model', type=str, default='save/model.pt')
